...
For example, to download version `v0.1.0` for Linux (amd64):

```bash
curl -L -o openshift-login https://github.com/SRGSSR/openshift-login/releases/download/v0.1.0/openshift-login-linux-amd64
